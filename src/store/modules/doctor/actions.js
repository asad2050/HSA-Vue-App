...
export default {
  ...
  async fetchPatientPastAppointments(context, payload) {
    let url =
      "/api/doctor/patients/" + payload + "/appointments";
    console.log(url);
    const token = context.rootGetters["auth/token"];
  ...
  async consultationComplete(context, payload) {
    const token = context.rootGetters["auth/token"];
    let url = "/api/doctor/consult/" + payload.id;
    console.log(url);
    const response = await fetch(url, {
      method: "PATCH",
      headers: {
  ...
  async  fetchAppointmentDetails(context,payload){
    const token = context.rootGetters["auth/token"];
    console.log(token);
    let url = "/api/doctor/appointments/" + payload.aId;
    const response = await fetch(url, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
  ...
  async fetchFeesDetails(context,payload){
    const token = context.rootGetters["auth/token"];
    let url ='/api/doctor/fees/'+payload.date
    console.log(token);
    const response = await fetch(url, {
      method: "GET",
      headers: {
  ...
  async fetchPatientDetails(context,payload){
    const token = context.rootGetters["auth/token"];
    let url ='/api/doctor/patients/'+payload.pId
    const response = await fetch(url, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
